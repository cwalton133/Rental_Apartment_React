...
class Payment(models.Model):
    ...
    return_url = models.URLField(max_length=200, blank=True, null=True)
    cancel_url = models.URLField(max_length=200, blank=True, null=True)
...
class PropertyReview(models.Model):
    ...
    def __str__(self):
        ...
        property_str = self.property.title if self.property else "No property"
        return f"{user_str} - {property_str}"
